  ...
  return Lang
    ? {
        ...
        Build: {
          ...
          ContainerContent: [
            ...
            [
              ...
              "Host a party dedicated to heat holders with the community-only tool NXDF-Meet. Share audio and video with each other in the virtual pool villa and enjoy the exclusive privilege of the holder. Those who own Metaaxle PFP can participate in the holder-only party.",
            ],
            [
              "TEMPLE",
        ...
        Rarity: {
          mainTitle: "Rarity",
          mainBoxTitle: [
            "All NFTs issued by Metaaxle are equipped with at least one item that can be used in the P2E metaverse to be provided in the future. NFTs with high rarity are given special functions in the metaverse. In addition, the NXDF ecosystem rewards vary according to the rarity of each NFT.",
          ],
          Content: [
            "No item",
            "Basic Status",
